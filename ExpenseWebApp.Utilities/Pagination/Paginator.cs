...
namespace ExpenseWebApp.Utilities.Pagination
{
    ...
    {
        public static async Task<PaginatorHelper<IEnumerable<TDestination>>> PaginateAsync<TSource, TDestination>(this IQueryable<TSource> querable, int pageSize, int pageNumber, IMapper mapper)
            where TSource : class
